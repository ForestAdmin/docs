...
One of the goals of Forest Admin is empowering technical teams to achieve more in less time. Your Forest Admin back-office is composed of 2 parts — the frontend (UI) and the backend — and for each one, you need the right tools:
...
Now that your back-office is live in production, you might want to add an extra step for testing purposes. Forest Admin allows you to create Remote Environments (for test, qa, staging, pre-production, etc.).
...
On your interface, you can check at all times what is your current Branch and how many layout changes were made on it. These information appear in the top banner of your back-office.
