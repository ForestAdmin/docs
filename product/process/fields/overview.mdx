---
title: Overview
description: Customize how fields behave in your Forest back-office
---
...
Field customization is applied in your agent code using a fluent API on the collection object. Changes are applied at the agent level and reflected in the Forest UI.
