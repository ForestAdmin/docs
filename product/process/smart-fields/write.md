...
{% tabs %}
{% tab title="collection.replaceFieldWriting('fullName', value => {" %}
```javascript
...
{% tabs %}
{% tab title="collection.replaceFieldWriting('firstName', async (value, context) => {" %}
```javascript
...
{% tabs %}
{% tab title="collection.replaceFieldWriting('job', (job, { action }) => {" %}
```javascript
