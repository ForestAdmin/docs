...
<Note>
  MCP Tasks require an MCP Server to be configured in your Forest Admin project. See [MCP Servers](/get-started/connect/integrations/mcp-servers) for details.
</Note>
