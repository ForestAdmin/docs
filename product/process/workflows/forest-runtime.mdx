...
<Note>
  The embedded executor takes its AI provider, observability and other settings from your agent. The environment variables in the sections below — including the [Tuning](#tuning) table — apply to a **standalone** deployment.
</Note>
