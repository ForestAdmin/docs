...
<Note>
  ...
  - **You can roll back at any time.** Ask us to switch back to browser execution; runs in progress keep the same guarantee.

  Your workflows themselves are untouched either way — nothing to rebuild or reconfigure.
</Note>
