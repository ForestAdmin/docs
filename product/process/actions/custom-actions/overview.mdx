...
Code-based actions let you implement custom business logic in your backend code. They provide full control over action behavior, forms, validation, and results.
...
<Frame caption="A custom action displayed in a Forest Admin table view">
