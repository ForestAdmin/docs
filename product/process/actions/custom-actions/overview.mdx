...
### [context & scope](/product/process/actions/custom-actions/context-scope)
...
### [result types](/product/process/actions/custom-actions/result-types)
...
### [forms](/product/process/actions/custom-actions/forms)
...
Understanding scopes and the context object
  ...
  ### [Related data invalidation](/product/process/actions/custom-actions/related-data-invalidation)
