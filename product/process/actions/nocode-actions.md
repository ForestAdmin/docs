...
* [Code-based actions](/product/process/actions/custom-actions/overview.md) - Build advanced actions with custom code for complex workflows, dynamic forms, and full control over execution and results
