...
<Frame caption="Toggling an action to Visible from collection settings">
  <img src="/images/actions/actions-visibility.png" alt="Making an action visible in Forest Admin" />
</Frame>
