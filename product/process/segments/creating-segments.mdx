...
description: "Create and manage segments through the Forest Admin UI — no code required"
---

A **segment** is a saved filter that gives you a dedicated tab on a collection, showing only the records that match specific conditions. Use them for workflows you consult regularly (e.g. "Pending transactions", "Signups this week").

For code-based segments, see [Smart Segments](/product/process/segments/smart-segments/overview).

## Create a segment

1. Enable **Layout Editor** mode (top right of your screen)
2. Click the **cog icon** next to the collection you want to edit
...
For advanced filtering, you can create a segment using a raw SQL query.
