...
description: "Route Forest Admin AI features through your own back-end (OpenAI or Anthropic) so your data never leaves your infrastructure"
---

By default, AI features in Forest Admin are processed by Forest Admin servers. To keep your data private, you can route AI requests through your own back-end using the `addAi` method, your data never leaves your infrastructure.
