...
If your project uses JavaScript, you can still get autocompletion using JSDoc type annotations. The pattern uses `@typedef` to import types from the generated typings file.
