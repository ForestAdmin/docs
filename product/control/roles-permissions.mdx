...
Forest Admin enables admins to create and manage custom roles with granular permission controls. The roles system allows organizations to define what actions users can perform within the platform.
...
Admins modify individual user roles and permission levels through the Users tab. Select the appropriate role and permission level for each user before saving changes.
