...
## Benefits of SSO
  ...
  * [Simplified Onboarding](#) - New employees automatically get Forest Admin access through your IdP provisioning
...
Forest Admin supports any SAML 2.0-compliant identity provider:
  ...
  * [Okta](/product/control/authentication/sso-providers/okta.md) - Setup guide for Okta SSO

  * [Azure AD / Entra ID](/product/control/authentication/sso-providers/azure.md) - Setup guide for Microsoft Azure AD

  * [AWS SSO](/product/control/authentication/sso-providers/aws.md) - Setup guide for AWS IAM Identity Center

  * [OneLogin](#) - SAML 2.0 compatible

  * [Auth0](#) - SAML 2.0 compatible
...
Use SAML debugging tools to diagnose issues:
  ...
  * [IdP Logs](#) - Check your IdP's logs for authentication errors and warnings
...
### Certificate Management
  ...
  * [Monitor Expiration](#) - Set reminders to renew certificates before expiration
...
## Next Steps
  ...
  * [2FA Setup](/product/control/authentication/2fa.md) - Add additional security with two-factor authentication

  * [Teams & Roles](/product/control/teams.md) - Organize SSO users into teams with appropriate roles

  * [Audit Logs](/product/control/audit.md) - Monitor SSO authentication events
