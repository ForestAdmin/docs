...
### [Google Workspace](/product/control/authentication/sso-providers/google)

Setup guide for Google Workspace SSO


  ### [Okta](/product/control/authentication/sso-providers/okta)

Setup guide for Okta SSO


  ### [Azure AD / Entra ID](/product/control/authentication/sso-providers/azure)

Setup guide for Microsoft Azure AD


  ### [AWS SSO](/product/control/authentication/sso-providers/aws)

Setup guide for AWS IAM Identity Center


  ### [Generic SAML](/product/control/authentication/sso-providers/generic-saml)
...
Automate user provisioning from your IdP
  ...
  ### [2FA Setup](/product/control/authentication/2fa)

Add additional security with two-factor authentication


  ### [Teams & Roles](/product/control/teams)
