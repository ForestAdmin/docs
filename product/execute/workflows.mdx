...
<CardGroup cols={3}>
  <Card title="Building workflows" href="/product/process/workflows/overview">
    For developers — how to design and configure workflow templates.
  </Card>
  <Card title="Inboxes & escalations" href="/product/manage/inbox">
