...
By default, Forest searches across the fields configured as searchable for that collection (configured by your developers in the agent), and matches on **contains**.
...
<Info>
Advanced search syntax is supported on Node.js agents (`@forestadmin/agent`) from version 1.36.18.
</Info>
