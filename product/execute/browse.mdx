...
Forest Admin gives you a broad set of tools to navigate your data: a flexible table view, full-text search, advanced filters, segments, and bulk selection. This page covers everything you need to find and explore records efficiently.
