...
description: "Build your own datasource by translating Forest Admin queries into your API's query language"
---
...
The translation strategy is an advanced approach for creating your own datasources that involves translating Forest Admin's query interface into the target API's query language.
...
Forest Admin permits declaring validation rules on primitive-type fields. These rules validate records during creation/updating in the back-office interface.
...
<Info>
Want to share your datasource with the community? Check out [Forest Admin experimental](/guides/forestadmin-experimental) to contribute.
</Info>
