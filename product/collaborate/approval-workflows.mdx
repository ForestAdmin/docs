...
| Filter | Description |
|--------|-------------|
| **Action** | Filter by the name of the Smart Action |
...
Approval workflows are configured in **Project Settings → Roles**. For each role, you can configure each action's approval behavior:
...
<CardGroup cols={2}>
  <Card title="Executing Actions" icon="bolt" href="/product/execute/actions">
    Learn how to trigger actions as an operator
  </Card>
  <Card title="Notes" icon="note-sticky" href="/product/collaborate/notes">
    Leave comments on records for your team
  </Card>
  <Card title="Inbox" icon="inbox" href="/product/collaborate/inbox">
    Distribute and process tasks across your team
  </Card>
  <Card title="Roles & Permissions" icon="lock" href="/product/control/roles-permissions">
    Configure action permissions by role
  </Card>
</CardGroup>
