...
Once an inbox is created, operators can access it from the main tab, or any Workspace on which the Inbox may have been configured as a source.

### To do

The **To do** section shows the number of unassigned records, and provides you with the **Start Processing** button to be automatically assigned to the next task, and redirected to the record.
...
- **Rename** the inbox or update its icon, to easily find it in the sidebar
...
- **Set a maximum number of concurrent tasks per operator**; when reached, clicking "Next ticket" redirects the operator to one of their in-progress tasks instead of assigning a new one from the To do queue.
