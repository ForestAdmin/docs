...
| The workflow contains an MCP Task step targeting an OAuth2-protected connector | Unprocessable — that step type is not yet supported in server-side runs; nothing starts |
