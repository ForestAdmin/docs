---
title: MCP Server
description: Integrate Forest with AI tools using the Model Context Protocol
---

# MCP server

Forest provides a Model Context Protocol (MCP) server that allows AI assistants and tools to interact with your back-office programmatically.
