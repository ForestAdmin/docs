...
<img src="/images/diagrams/mcp-standalone.svg" alt="Standalone: the AI agent hits the MCP server running as a separate service, which talks to your Forest back-end and your data" width="100%" />
...
<img src="/images/diagrams/mcp-mounted.svg" alt="Mounted: the AI agent hits the /mcp endpoint mounted directly inside your Forest back-end, which talks to your data" width="100%" />
...
<Note>
  Your back-end URL can be found in the Forest Admin UI's Project Settings, under the Environments tab.
