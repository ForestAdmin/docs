...
If the total count isn't needed, you can disable it per collection:
...
<CardGroup cols={2}>
  <Card title="Collection Configuration" icon="sliders" href="/product/build/collection-configuration">
    All collection-level settings including page size
  </Card>
  <Card title="Layout Maintenance" icon="wrench" href="/product/build/layout-maintenance">
    Performance optimization for layouts on large datasets
  </Card>
  <Card title="Search Configuration" icon="magnifying-glass" href="/product/build/search-configuration">
    Configure which fields are searchable and how
  </Card>
</CardGroup>
