...
<Info>
  Smart Charts require a [Forest Pro plan](https://www.forestadmin.com/pricing).
</Info>
...
- [Charts overview](/product/manage/charts/overview) — the no-code chart types
- [Dashboards](/product/manage/dashboards) — where charts live
