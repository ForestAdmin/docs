...
**Charts** in Forest Admin let you build visual data representations directly from your collections — without writing custom code. Use them to monitor KPIs, track trends, and create dashboards your operations team can act on.
...
Forest Admin supports six chart types:
...
<CardGroup cols={2}>
  <Card title="Chart Patterns & Examples" icon="chart-line" href="/product/manage/charts/chart-patterns">
    Practical examples for common analytics use cases
  </Card>
  <Card title="Dashboards" icon="gauge" href="/product/manage/dashboards">
    Organize charts into shareable dashboards
  </Card>
  <Card title="Aggregations (Developer)" icon="code" href="/product/process/for-tech-teams/aggregations/overview">
    Define custom aggregations for use in charts
  </Card>
  <Card title="Workspaces" icon="layout" href="/product/build/workspaces">
    Embed charts in custom operational views
  </Card>
</CardGroup>
