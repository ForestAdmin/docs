...
A **dashboard** is a tab in your Forest Admin project where you group charts to track KPIs and operational metrics. You can create as many dashboards as needed — one per team, use case, or business domain.
...
Charts are the building blocks of a dashboard. Forest Admin supports two ways to populate chart data:
