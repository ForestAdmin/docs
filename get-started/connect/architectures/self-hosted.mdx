...
This approach is valuable when Forest needs your application's running code: an in-process service, a transaction to join, a singleton your business logic depends on. If you use Sequelize, Mongoose, ActiveRecord or Mongoid, Forest also reads your model definitions directly — though that alone does not require in-app, since importable models work from a separate process too.
