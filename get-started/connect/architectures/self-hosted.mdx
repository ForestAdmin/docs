...
<img src="/images/diagrams/self-hosted.svg" alt="When a user opens Forest, the browser loads UI and config from Forest's public endpoints, but all data requests go directly to your Forest back-end behind your firewall — your data never reaches Forest servers" width="100%" />
