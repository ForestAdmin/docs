...
This approach suits a back-end that needs your application's running code, such as an in-process service or a transaction to join. It can also read your ORM models directly, but so can a standalone back-end that imports them.
...
<Info>
**Recommendation**: We recommend **standalone deployment** for cleaner architecture and better separation of concerns. See [Deployment options](/get-started/connect/architectures/deployment-options) for the cases that call for in-app.
</Info>
