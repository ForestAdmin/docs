...
<Info>
**Recommendation**: We recommend **standalone deployment** for cleaner architecture and better separation of concerns. Use **in-app** only if you need to reuse your ORM models or existing business logic — see [Deployment options](/get-started/connect/architectures/deployment-options) for how to make that call, and how to stay standalone inside a monorepo.
</Info>
