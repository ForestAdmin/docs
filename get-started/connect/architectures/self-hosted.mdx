...
description: "Deploy Forest agent in your infrastructure while Forest hosts the UI - the most popular deployment option"
---
...
|-----------|-----------|----------|------------------|
| **Your Agent** | You | Your infrastructure | • Runs in Node.js or Ruby<br/>• Direct access to your database<br/>• Executes business logic (Smart Actions, Fields, Hooks)<br/>• Handles authentication and authorization<br/>• Exposes REST API for Forest UI |
