...
<Info>
**Node.js only** - This page covers TypeScript autocompletion setup for the Node.js agent. For information about Forest Admin data types, see [Data Types](/get-started/connect/data-types).
</Info>
