...
description: "Enable TypeScript autocompletion and type safety for your Forest Node.js agent"
---
...
The Forest Node.js agent, built entirely in TypeScript, provides comprehensive autocompletion capabilities for collection names, field names, and handler parameters.
