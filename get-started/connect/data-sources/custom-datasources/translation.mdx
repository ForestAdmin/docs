...
description: "Build your own datasource by translating Forest queries into your API's query language"
---
...
<Frame caption="A translation datasource exposes capabilities (count, filter, sort) that Forest queries against">
  <img src="/images/datasources/customdatasource-count-capability.png" alt="Translation datasource capabilities diagram" />
</Frame>
...
<Info>
Want to share your datasource with the community? Check out [Forest experimental](/guides/forestadmin-experimental) to contribute.
</Info>
