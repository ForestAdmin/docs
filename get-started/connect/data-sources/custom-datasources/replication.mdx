...
<img src="/images/diagrams/replication.svg" alt="The target API feeds a replica cache held by the Forest back-end via three update methods (scheduled rebuild, change polling, and change pushing), and Forest queries the replica" width="100%" />
