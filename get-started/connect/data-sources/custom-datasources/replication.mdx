...
<Frame caption="A minimal replica datasource: cache controlled by the agent">
  <img src="/images/datasources/customdatasource-minimal.png" alt="Minimal replica datasource architecture" />
</Frame>
...
The Forest Node.js agent uses a SQL database as its underlying cache mechanism. By default, an in-memory SQLite database is used.
...
Real-world scenarios require keeping the Forest agent to display up-to-date data.
...
<Info>
Want to share your custom datasource with the community? Check out [Forest experimental](/guides/forestadmin-experimental) to contribute.
</Info>
