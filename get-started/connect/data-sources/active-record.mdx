...
description: "Connect Forest to your ActiveRecord models with support for relationships and Live Query"
---
...
The `id` and `type` fields of polymorphic relationships remain visible in the interface. Hide them through agent customization or frontend configuration if desired.
