...
description: "Configure your Forest agent with required environment variables"
---

Environment variables are used to configure your Forest agent securely, keeping sensitive information separate from your codebase.
...
**Purpose:**
- Authenticates your agent with Forest
- Links your agent to your Forest project
