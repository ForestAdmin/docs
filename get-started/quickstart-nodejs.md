...
Now that you are fully onboarded, the only missing part is to add a data source. Forest Admin provides a way to [create your own](../datasources/custom/README.md), but for this example, we will add a [SQL data source](../datasources/provided/sql.md).
