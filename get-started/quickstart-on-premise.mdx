...
description: "Deploy Forest in a fully air-gapped environment"
---

## On-Premise Deployment

On-Premise deployment provides complete control and isolation by running all Forest components (agent, backend, and UI) within your infrastructure.
...
graph TD
    subgraph Your_Infrastructure["🏢 Fully hosted on your servers (Air-gapped)"]
        ...
        Agent["⚙️ Forest Agent<br/>(Node.js or Ruby)"]
        UI["🌐 Forest UI<br/>(Self-hosted)"]
        Servers["🖥️ Forest Backend<br/>(Self-hosted)"]
...
<Warning>
**Not available for self-service installation.** On-Premise deployment requires coordination with Forest's team to ensure proper setup and licensing.
</Warning>
