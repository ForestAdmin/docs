...
Forest Admin Cloud is the fastest way to get started. We host and manage everything for you—connect your database.
...
Enter your connection URI directly in Forest Admin's interface:
