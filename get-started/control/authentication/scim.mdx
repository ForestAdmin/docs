...
<CardGroup cols={2}>
  <Card title="Automated Provisioning" icon="user-plus">
    New employees automatically get Forest access when added to your IdP
  </Card>
  ...
  <Card title="Synchronized Updates" icon="arrows-rotate">
    User profile changes in IdP automatically sync to Forest
  </Card>
...
- **Audit Trail**: SCIM events logged in Forest audit logs
...
<CardGroup cols={2}>
  <Card title="SSO Setup" icon="key" href="/get-started/control/authentication/sso">
    Configure SSO before enabling SCIM
  </Card>

  <Card title="Teams & Roles" icon="users" href="/get-started/control/teams">
  ...
  <Card title="Scopes" icon="filter" href="/get-started/control/scopes-and-visibility">
