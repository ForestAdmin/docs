...
<img src="/images/diagrams/scim.svg" alt="SCIM provisioning sequence between your identity provider and the Forest SCIM API: POST to provision, PATCH to update, DELETE to deprovision" width="100%" />
