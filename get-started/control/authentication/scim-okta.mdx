...
<Warning>
Removing a group in Okta that was created from, or linked to, a Forest Admin team will **delete** that Forest Admin team.
</Warning>

<Warning>
When you link an Okta group to a Forest Admin team, the team is renamed to match the group name, unless you disable that option.
</Warning>
