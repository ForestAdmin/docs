...
<CardGroup cols={2}>
  ...
  <Card title="Azure AD" icon="microsoft" href="/product/control/authentication/sso-providers/azure">
    Set up SSO with Microsoft Azure Active Directory
  </Card>
  <Card title="Okta" icon="shield" href="/product/control/authentication/sso-providers/okta">
    Integrate Forest Admin with Okta identity provider
  </Card>
  <Card title="AWS IAM" icon="aws" href="/product/control/authentication/sso-providers/aws">
    Configure SSO using AWS IAM Identity Center
  </Card>
  <Card title="Generic SAML" icon="key" href="/product/control/authentication/sso-providers/generic-saml">
