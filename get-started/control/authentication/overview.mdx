...
Forest Admin supports multiple authentication methods to access your back-office:
...
<CardGroup cols={2}>
  ...
  <Card title="Azure AD" icon="microsoft" href="/get-started/control/authentication/sso-providers/azure">
    Set up SSO with Microsoft Azure Active Directory
  </Card>
  <Card title="Okta" icon="shield" href="/get-started/control/authentication/sso-providers/okta">
    Integrate Forest Admin with Okta identity provider
  </Card>
  <Card title="AWS IAM" icon="aws" href="/get-started/control/authentication/sso-providers/aws">
    Configure SSO using AWS IAM Identity Center
  </Card>
  <Card title="Generic SAML" icon="key" href="/get-started/control/authentication/sso-providers/generic-saml">
    Set up SSO with any SAML 2.0 identity provider
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Okta SCIM" icon="shield" href="/get-started/control/authentication/scim-okta">
    Automatic user provisioning with Okta
  </Card>
  <Card title="OneLogin SCIM" icon="key" href="/get-started/control/authentication/scim-onelogin">
    Automatic user provisioning with OneLogin
  </Card>
  <Card title="Okta Manual Setup" icon="wrench" href="/get-started/control/authentication/scim-okta-manual">
