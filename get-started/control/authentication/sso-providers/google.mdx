...
| Entity ID | Displayed in your Forest Admin Organization settings |
...
5. Download or copy the IdP metadata and paste it into Forest Admin (see [SSO configuration guide](/get-started/control/authentication/sso-providers/overview))
...
- Ensure the `Name ID` (primary email) in your IdP matches the **email address used on Forest Admin accounts**
