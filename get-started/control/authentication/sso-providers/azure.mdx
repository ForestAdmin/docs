...
2. Select **Create your own application** (Forest Admin is not in the gallery)
...
6. In Forest Admin Organization settings, select **XML file endpoint** and paste the URL

## Troubleshooting

- Double-check all endpoints and certificate expiration dates
- Ensure `nameID` is configured to use the **email address used on Forest Admin accounts**
