...
5. In Forest Admin Organization settings, select **XML file endpoint** and paste the Metadata URL

## Troubleshooting

- Double-check all endpoints and certificate expiration dates
- Ensure `Name ID format` is set to **EmailAddress** and matches the email used on Forest Admin accounts
