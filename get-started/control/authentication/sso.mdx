...
<CardGroup cols={2}>
  <Card title="Centralized Authentication" icon="key">
    Users authenticate once through your IdP and access Forest Admin
  </Card>
...
<Warning>
**Emergency Access**: Always keep at least one admin account with password authentication enabled. This ensures access to Forest Admin if SSO has issues.
</Warning>
