...
<img src="/images/diagrams/sso.svg" alt="SP-initiated SAML 2.0 flow: the user starts at Forest, authenticates against the identity provider, and is redirected back with a signed assertion" width="100%" />
