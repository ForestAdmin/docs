...
<CardGroup cols={2}>
  ...
  <Card title="Protect Sensitive Data" icon="database">
    Add extra protection for back-offices accessing customer or financial data
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="IP Whitelisting" icon="globe" href="/get-started/control/security/ip-whitelisting">
    Add network-level security restrictions
  </Card>

  <Card title="Auto Logout" icon="clock" href="/get-started/control/security/auto-logout">
    Configure session timeouts and auto-logout policies
  </Card>

  <Card title="Audit Logs" icon="list" href="/get-started/control/audit">
