...
<Info>
**Admin Logs**: This page covers data activity logs. Permission management changes (role modifications, user access changes, etc.) are tracked separately in Admin Logs. [View Admin Logs documentation →](/get-started/control/admin-logs)
</Info>
