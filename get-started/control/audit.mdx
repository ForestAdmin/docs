...
description: "Track and monitor all user actions in Forest"
---
...
<Info>
**API Access**: Audit logs are also available programmatically through the Forest API. See the [Activity Logs API reference](/reference/api/endpoints/activity-logs) for more information.
</Info>

<Info>
**Admin Logs**: This page covers data activity logs. Permission management changes (role modifications, user access changes, etc.) are tracked separately in Admin Logs. [View Admin Logs documentation →](/reference/api/endpoints/admin-logs)
</Info>
