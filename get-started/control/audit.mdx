...
<Info>
To also record **what changed** — field-level before/after values, in a database you own — enable the [audit trail](/get-started/control/audit-trail) on your agent. Each record's **Activity** tab then shows the diffs alongside these logs.
</Info>
