...
<Steps>
  ...
  <Step title="Deploy your back-end to your infrastructure">
    ...
    On a SQL datasource, [pre-compute the introspection](/get-started/connect/data-sources/sql#pre-compute-the-introspection) so restarts don't re-scan your schema.
  </Step>
