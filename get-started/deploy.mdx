...
<Steps>
  <Step title="Decide where it runs">
    Its own service, or inside an application process you already have. Default to a separate service, so the back-end's restarts and boot work stay off the process serving your users — you can still reuse your ORM models from a shared codebase. See [Deployment options](/get-started/connect/architectures/deployment-options).
  </Step>
