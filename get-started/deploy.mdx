...
<Steps>
  <Step title="Decide where it runs">
    Its own service, or inside an application process you already have. We recommend a separate service unless you are reusing your ORM models — see [Deployment options](/get-started/connect/architectures/deployment-options).
  </Step>
