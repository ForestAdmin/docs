...
<CardGroup cols={3}>
  ...
  <Card title="Migrating from a v1 agent" icon="arrow-right-arrow-left" href="/guides/migration/from-v1/overview">
    Move from a legacy agent (forest-express-sequelize, forest-express-mongoose, forest-rails, django-forestadmin) to the current generation.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Guides" icon="map" href="/guides/overview">
    Deployment per platform, migration from v1, integrations, and best practices for security and performance.
  </Card>
...
<CardGroup cols={3}>
  <Card title="Cloud" icon="cloud" href="/get-started/connect/architectures/cloud">
    Fully-managed. Connect your database, Forest hosts the agent and UI. Fastest path to a running workflow.
  </Card>
  <Card title="Self-Hosted" icon="server" href="/get-started/connect/architectures/self-hosted">
    Most popular. Forest hosts the UI; you run the agent in your infrastructure. Your data never leaves your network.
  </Card>
