---
title: Performance
description: "Tips and patterns to optimize your Forest Admin agent"
---
...
If your segment logic can be expressed as a Forest Admin condition tree, use it instead of running a raw query and filtering by IDs. The agent can push the condition tree down to the database as a native query, which is much faster.
