...
We now support multiple data sources in the same project: you can [connect as many as you need](../../datasources/getting-started/README.md), combine relational and non-relational databases, and use different ORMs for each one.
