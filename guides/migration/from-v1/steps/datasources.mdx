...
Legacy agents often converted `snake_case` columns to `camelCase` for you. The current agent exposes what the database holds, so restore the old names explicitly:
