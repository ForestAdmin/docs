...
Many queries map directly to Forest Admin condition trees, giving much better performance than performing the query yourself and then building a naive `id IN (...)` condition.
