...
`push` means moving your Branch's changes to a Remote Environment set as the origin of your Branch. To achieve this, you'll be using Forest Admin CLI's [push](forest-cli-commands/push.md) command:
