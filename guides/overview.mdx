...
---
Practical guides to help you deploy, migrate, integrate, and optimize your Forest implementation.
...
<CardGroup cols={2}>
  ...
  >
    Deploy Forest to production on AWS, Heroku, and other platforms
  </Card>
  <Card
    title="Migration"
  ...
  >
    Migrate from v1 to the latest version of Forest
  </Card>
  <Card
...
<AccordionGroup>
  <Accordion title="Migrating from v1" icon="code-branch">
    Complete migration path from Forest v1 to the latest version:
