...
Every GitBook site needs a `docs.json` file with the core configuration settings. Learn more about the [properties](#properties) below.
...
Example: `my-project`
  ...
  Array of `name`s and `url`s of links you want to include in the topbar
    ...
    The url once you click on the button. Example: `https://docs.gitbook.com
