...
A legacy agent is any Forest agent prior to the current generation — the era when the product was branded as Forest Admin and centered on building admin panels. The legacy agents are:
...
| `django-forestadmin` v1 | Python / Django | End-of-life soon |
...
<CardGroup cols={2}>
  <Card title="JavaScript (Express) agents" icon="js" href="/legacy/javascript-agents/README">
    Reference for `forest-express-sequelize` and `forest-express-mongoose`. Setup, customization, and how-tos for v1 Node.js agents.
  </Card>
  <Card title="Ruby on Rails agent" icon="gem" href="/legacy/ruby-agent/README">
    Reference for `forest-rails`. Setup, customization, and how-tos for the v1 Ruby agent.
  </Card>
  <Card title="Python (Django) v1" icon="python" href="/legacy/python-agent-v1">
    Reference for `django-forestadmin` v1. Approaching end-of-life — migrate as soon as possible.
  </Card>
  <Card title="Migration guides (legacy index)" icon="list-check" href="/legacy/migration-guides">
    Index of v1 → v2 migration paths per agent.
  </Card>
</CardGroup>
