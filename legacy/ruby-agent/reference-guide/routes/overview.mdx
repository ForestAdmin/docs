...
<Info>
If you want to trigger logic unrelated to Forest Admin's basic routes (create, update, etc), head over to our [Smart actions](/legacy/ruby-agent/reference-guide/actions/create-and-manage-smart-actions/overview#what-is-a-smart-action) page.
</Info>
