...
Your Forest Admin panel is composed of 2 parts - [the frontend (UI) and the backend](/legacy/ruby-agent/reference-guide/how-it-works/overview) - and for each one you need the right tools:
...
- Versioning: use [Forest CLI](/legacy/ruby-agent/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/overview) to seamlessly manage your layout versions

### Development workflow

For a simple and hands-on **example** of how to develop on Forest Admin according to our recommended development workflow, see [this page](/legacy/ruby-agent/getting-started/development-workflow).
