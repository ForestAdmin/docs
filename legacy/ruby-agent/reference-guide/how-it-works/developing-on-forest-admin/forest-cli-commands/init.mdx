...
- allow you to log in if you haven't already done so with [forest login](/legacy/ruby-agent/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/login)
...
<Warning>
`forest init` is not meant to help you create a new project. If you don't have an existing project yet, please refer to [this guide](/legacy/ruby-agent/getting-started/setup-guide).
</Warning>
...
All Forest CLI commands require to be **authenticated**. You can do this on the fly using `forest init` or use `forest login` first. Refer to the [forest login](/legacy/ruby-agent/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/login) page if you need further details.
