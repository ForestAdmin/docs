...
<Info>
To manipulate your layouts, you will be using [Forest CLI](/legacy/ruby-agent/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/overview).
</Info>
...
The branch `my-branch` is based on the production layout. Any changes made on it are saved in your branch's layout and can later be [applied ](/legacy/ruby-agent/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/deploy)on it.
...
To create a branch, you'll need to use [Forest CLI](/legacy/ruby-agent/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/overview). Make sure you've created your local development environment using the [init](/legacy/ruby-agent/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/init) command. Then, to create a branch named `my-branch` based on your `production` environment, simply run:
...
To learn more about the `branch` command, please visit [this page](/legacy/ruby-agent/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/branch).
...
<Info>
To switch your _current_ branch to another existing branch, check out the [switch](/legacy/ruby-agent/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/switch) command.
</Info>
