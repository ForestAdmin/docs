...
Those actions come out-of-the-box. We've covered them in details _from a route perspective_ in [Routes](/legacy/ruby-agent/reference-guide/routes/overview), but here is what the most common ones look like in the interface:
