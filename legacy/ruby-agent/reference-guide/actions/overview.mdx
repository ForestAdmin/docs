...
Those actions come out-of-the-box. We've covered them in details _from a route perspective_ in [Routes](/legacy/ruby-agent/reference-guide/routes/overview). The most common ones are:
