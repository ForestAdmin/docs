...
Ids configured in the action intent will be provided as usual within your context. Please refer to this [documentation](/legacy/ruby-agent/reference-guide/actions/create-and-manage-smart-actions/README#creating-a-smart-action) for more details.