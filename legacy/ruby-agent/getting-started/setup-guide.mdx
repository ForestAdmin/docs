...
<Info>
For the purpose of this tutorial, we have used [this database](/legacy/ruby-agent/how-tos/databases/use-a-demo-database). Feel free to use it if you don't have one.
</Info>
...
<Info>
You may have to [add CORS headers](/legacy/ruby-agent/how-tos/setup/configuring-cors-headers) to enable the domain `app.forestadmin.com` to trigger API call on your Application URL, which is on a different domain name (e.g. _localhost:8000_).
</Info>
...
Next, we recommend reading about our recommended [development workflow](/legacy/ruby-agent/getting-started/development-workflow).
