...
- An existing app (, Rails or Express with ActiveRecord and Mongoid)
...
- Using an existing app: integrate Forest Admin into your Ruby on Rails, , Ruby on Rails app with Express (and ActiveRecord ORM or Mongoid ORM).
...
- Ruby on Rails app
-  project
- Ruby on Rails app with Express and ActiveRecord ORM
- Ruby on Rails app with Express and Mongoid ORM
...
#### Install Forest Admin using an existing Ruby on Rails app with Express &#x20;

Requirements:&#x20;

- Using ActiveRecord or Mongoid ORM
- ActiveRecord version must be 5.21 or higher
- Mongoid version must be 5 or higher
