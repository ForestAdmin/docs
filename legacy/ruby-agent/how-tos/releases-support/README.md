...
### Express ActiveRecord

A new agent generation has been released to integrate with Ruby on Rails projects.
The only way to keep your Forest Admin project running in the future will be to migrate from the [agent v9](https://github.com/ForestAdmin/forest-express-sequelize) to the new [Ruby on Rails agent](https://github.com/ForestAdmin/agent-nodejs).
...
A new agent generation has been released to integrate with Ruby on Rails projects.
The only way to keep your Forest Admin project running in the future will be to migrate from the [agent v9](https://github.com/ForestAdmin/forest-express-mongoose) to the new [Ruby on Rails agent](https://github.com/ForestAdmin/agent-nodejs).
Please follow the dedicated [migration guide](https://docs.forestadmin.com/developer-guide-agents-nodejs/getting-started/migrating).
