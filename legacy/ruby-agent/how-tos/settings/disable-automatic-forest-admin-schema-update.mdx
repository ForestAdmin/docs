...
<Warning>
By doing so, you will need to manually synchronize your Forest Admin schema [using our CLI.](/legacy/ruby-agent/how-tos/maintain/manage-your-forest-admin-programmatically)
</Warning>
