...
**Legacy Documentation:** [Agent v1 docs](/legacy/agent-v1/README)
...
**⚠️ Important:** This documentation section is not indexed by search engines and excluded from internal search. If you're starting a new project, please use the [current documentation](/get-started/introduction).
