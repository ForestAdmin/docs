...
<Info>
For the purpose of this tutorial, we have used [this database](/legacy/javascript-agents/how-tos/databases/use-a-demo-database). Feel free to use it if you don't have one.
</Info>

At the end of your onboarding, you get out-of-the-box CRUD, search, filtering and export on your data. However, your business logic likely requires more features. What if you need to...
...
<Info>
You may have to [add CORS headers](/legacy/javascript-agents/how-tos/setup/configuring-cors-headers) to enable the domain `app.forestadmin.com` to trigger API call on your Application URL, which is on a different domain name (e.g. _localhost:8000_).
</Info>
...
Next, we recommend reading about our recommended [development workflow](/legacy/javascript-agents/getting-started/development-workflow).
