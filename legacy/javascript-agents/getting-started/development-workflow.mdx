...
<Info>
The following workflow requires that you have generated your project and pushed it to Production. If it's not the case, check out our [quick start](/legacy/javascript-agents/getting-started/setup-guide).
</Info>
...
For a more in-depth walkthrough of the `init` command, check out [this page](/legacy/javascript-agents/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/init).
...
For a more in-depth walkthrough of the `branch` command, check out [this page](/legacy/javascript-agents/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/branch).
...
<Info>
Want to add a testing phase before you deploy to production? Check out how to [create a staging environment](/legacy/javascript-agents/reference-guide/how-it-works/environments#creating-a-remote-environment) and how to [push changes](/legacy/javascript-agents/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/push) onto it.
</Info>
