...
<Warning>
This does **not** mean your project is deployed to production on Forest Admin. To deploy to production, check out [this section](/legacy/javascript-agents/reference-guide/how-it-works/environments#deploying-to-production) after you've completed the above steps.
</Warning>
