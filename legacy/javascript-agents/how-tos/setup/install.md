...
- An existing app (, Rails or Express with Sequelize and Mongoose)
...
- Using an existing app: integrate Forest Admin into your Ruby on Rails, , Node.js app with Express (and Sequelize ORM or Mongoose ORM).
