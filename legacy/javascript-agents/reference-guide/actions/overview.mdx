...
Those actions come out-of-the-box. We've covered them in details _from a route perspective_ in [Routes](/legacy/javascript-agents/reference-guide/routes/overview). The most common ones are:
...
<Info>
Smart actions can be triggered from the _Actions_ button or directly from a Summary view.
</Info>
