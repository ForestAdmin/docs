...
To initialize the middleware, here are the requirements (refer to the [code snippet above](/legacy/javascript-agents/reference-guide/how-it-works/developing-on-forest-admin/express-packages#initialise-forestadmin)):&#x20;
