...
The `forest deploy` command enables you to apply some layout changes to your [reference](/legacy/javascript-agents/reference-guide/how-it-works/developing-on-forest-admin/using-branches#what-is-a-branch) environment.
