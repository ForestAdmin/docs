...
As you've learnt in [previous pages](/legacy/javascript-agents/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/push), the `forest push` command lets you push changes made in the layout to a remote environments and later `deploy` them to your production.
