...
- allow you to log in if you haven't already done so with [forest login](/legacy/javascript-agents/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/login)
...
<Warning>
`forest init` is not meant to help you create a new project. If you don't have an existing project yet, please refer to [this guide](/legacy/javascript-agents/getting-started/setup-guide).
</Warning>
...
All Forest CLI commands require to be **authenticated**. You can do this on the fly using `forest init` or use `forest login` first. Refer to the [forest login](/legacy/javascript-agents/reference-guide/how-it-works/developing-on-forest-admin/forest-cli-commands/login) page if you need further details.
...
If you're seeing the above message, please refer to the [v1 to v2 migration guide](/guides/migration/from-v1/overview).
</Warning>
