...
Your Forest Admin panel is composed of 2 parts - [the frontend (UI) and the backend](/legacy/javascript-agents/reference-guide/how-it-works/overview) - and for each one you need the right tools:
