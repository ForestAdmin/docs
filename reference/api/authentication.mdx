...
description: "Learn how to authenticate requests to the Forest Public API"
---
...
curl -H "Authorization: Bearer fa_your_api_token_here" \
  https://public-api.forestadmin.com/v1/project/{projectName}/environment/{environmentName}public-api.forestadmin.com/v1/project/{projectName}/environment/{environmentName}/activity-logs
```
...
uri = URI('https://public-api.forestadmin.com/v1/project/{projectName}/environment/{environmentName}public-api.forestadmin.com/v1/project/{projectName}/environment/{environmentName}/activity-logs')
