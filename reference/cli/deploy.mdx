...
You can also deploy layout changes directly from the Forest Admin UI. When a remote environment has changes ready to deploy to production, a banner appears at the top with a **"Deploy to …"** link.
