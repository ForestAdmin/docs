...
### [Environments](/reference/cli/environments)

| Command | Description |
|---|---|
| `forest environments` | List all environments |
| `forest environments:create` | Create a new environment |
| `forest environments:get` | Get an environment's configuration |
...
### [Projects](/reference/cli/projects)

| Command | Description |
|---|---|
| `forest projects` | List all projects |
| `forest projects:get` | Get a project's configuration |
| `forest projects:create:demo` | Create a project with a zero-DB demo datasource |
| `forest projects:create:sql` | Create a project from a SQL database |
| `forest projects:create:nosql` | Create a project from a NoSQL (Mongo) database |

### [Layout](/reference/cli/layout)

| Command | Description |
|---|---|
| `forest layout:pull` | Pull an environment's layout into a `forest-layout.json` file |
| `forest layout:apply` | Apply a `forest-layout.json` to an environment |
| `forest layout:patch` | Patch the layout directly (single PATCH per domain, like the front) |

### [Workflows](/reference/cli/workflows)

| Command | Description |
|---|---|
| `forest workflow:apply` | Create or update a workflow from a JSON `steps` spec (compiles to BPMN) |

### [Roles](/reference/cli/roles)

| Command | Description |
|---|---|
| `forest roles:create` | Create a role |
| `forest roles:apply` | Apply a wide-format CSV of role permissions to an environment |
| `forest roles:copy` | Copy roles between environments |
| `forest roles:export` | Export an environment's roles to a CSV |

### [Teams](/reference/cli/teams)

| Command | Description |
|---|---|
| `forest teams:create` | Create a team |
| `forest teams:delete` | Delete a team |
| `forest teams:copy-layout` | Copy a team's layout to another team |

### [Users](/reference/cli/users)

| Command | Description |
|---|---|
| `forest users:list` | List the users of a project |
| `forest users:invite` | Invite users to a project |
| `forest users:edit` | Edit a user's role, teams, or permission level |
