...
You can also push layout changes directly from the Forest Admin UI. When a remote environment has unpushed changes, a banner appears at the top with a **"Push to …"** link.
