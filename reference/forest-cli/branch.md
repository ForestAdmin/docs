The `forest branch` command is at the center of what your Forest Admin development workflow should look like. As explained on [this page](../using-branches.md), it allows you to manage your layouts, a bit like you would use git's branches for your code.
...
Any branch reflects layout changes (i.e. configuration changes in your UI) that you've made on that branch. To make this possible, a branch needs an **origin**, which is the state of the layout you started from and made these layout changes on. This is why you need to [have a Production Environment](../environments.md#deploying-to-production) (ideally) or simply a Remote Environment: those Environments can serve as the origin of your branches.
