...
1. **[Migration overview](/guides/migration/from-v1/overview)**
2. **[Datasources](/guides/migration/from-v1/steps/datasources)**
3. **[Smart Actions](/guides/migration/from-v1/steps/smart-actions)**
4. **[Smart Fields](/guides/migration/from-v1/steps/smart-fields)**
5. **[Smart Relationships](/guides/migration/from-v1/steps/smart-relationships)**
...
- Smart Fields support model methods
